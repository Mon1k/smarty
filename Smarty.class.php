...
/* $Id: Smarty.class.php 49 2014-01-07 21:14:32Z Monk $ */
...
class Smarty
{
    ...
    /**
     * The public function used for cache file handling. If not set, built-in caching is used.
     *
     * @var null|string public function name
     */
    ...
    /**
     * If a template cannot be found, this PHP public function will be executed.
     * Useful for creating templates on-the-fly or other special action.
     *
     * @var string public function name
     */
 ...
 */
    ...
    /**
     * Registers custom public function to be used in templates
     *
     * @param string $public function the name of the template function
     * @param string $function_impl the name of the PHP public function to register
     */
     ...
     *
     * @param string $public function name of template function
     */
    ...
    /**
     * Registers block public function to be used in templates
     *
     * @param string $block name of template block
     * @param string $block_impl PHP public function to register
     */
     ...
     *
     * @param string $public function name of template function
     * @param string $function_impl name of PHP public function to register
     */
     ...
     * @param string $modifier_impl name of PHP public function to register
     */
    ...
    /**
     * Registers a prefilter public function to apply
     * to a template before compiling
     *
     * @param string $public function name of PHP public function to register
     */
     ...
     *
     * @param string $public function name of PHP function
     */
    ...
    /**
     * Registers a postfilter public function to apply
    ...
    /**
     * Registers an output filter public function to apply
     ...
     * This public function is for advanced use only, not normally needed.
     *
   ...
   /**
        ...
        if (!$_return) {
            ...
            if (!empty($this->default_template_handler_func)) {
                if (!is_callable($this->default_template_handler_func)) {
                    $this->trigger_error("default template handler public function \"$this->default_template_handler_func\" doesn't exist.");
                } else {
    ...
    /**
     * callback public function for preg_replace, to call a non-cacheable block
     * @return string
     */
    ...
    /**
     * get or set an array of cached attributes for public function that is
     * not cacheable
     * @return array
     */
